...
public class Project
{
	...
	public static void main(String[] args)
	{
		...
		do
		{
			...
			//DEBUG// 
			//System.out.print(lineList); //^ is working
			
			//test
			//String[] lines = new String[lineList.size()];
			//lines = lineList.toArray(lines);

//TODO:	fix this part, always outputs "Line Number 1" and "Timothy Smith", even when first called.
			for(String s : lineList) //iterate through list
			{
				if (s.contains(searchString) != false)  //if element contains a match
				{
					System.out.printf("Line number " + (lineList.indexOf(searchString)+2));  //print the index value +1
					System.out.println();
					System.out.printf(lineList.get(lineList.indexOf(searchString)+1));
					System.out.println();
					//put code for arrow here
					System.out.println("get index of arrow here");
					System.out.println();
					//System.out.println();
	...
	//method to manually sort, nullointerexception being thrown
/*	private static String[] sorter(String[] array, int position)
	...
	public static List<String> createLineList()
	{
